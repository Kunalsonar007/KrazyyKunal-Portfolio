(function (global, factory) {
  ...
  var Animate = /*#__PURE__*/function () {
    ...
    _proto.advance = function advance(deltaTime) {
      ...
      (_this$onUpdate = this.onUpdate) == null || _this$onUpdate.call(this, this.value, {
        completed: completed
      });
      if (completed) {
        this.stop();
  ...
  var Dimensions = /*#__PURE__*/function () {
    ...
    _proto.destroy = function destroy() {
      ...
      (_this$wrapperResizeOb = this.wrapperResizeObserver) == null || _this$wrapperResizeOb.disconnect();
      (_this$contentResizeOb = this.contentResizeObserver) == null || _this$contentResizeOb.disconnect();
    };
